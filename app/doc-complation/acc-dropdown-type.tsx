...
export default function AccDropdownType() {
    return (
        <div className='w-full flex flex-col gap-3'>
            <h1 className='text-[16px] font-semibold'>Account Type</h1>
            <div className='w-full flex flex-col gap-2'>
                ...
                <p className='text-[14px] text-gray-500'>Select your account type here.</p>
            </div>
        </div>
    );
}

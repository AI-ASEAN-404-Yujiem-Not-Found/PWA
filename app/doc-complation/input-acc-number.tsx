...
export default function InputAccNumber() {
    return (
        <div className='w-full flex flex-col gap-3'>
            <h1 className='text-[16px] font-semibold'>Account Number</h1>
            <div className='w-full flex flex-col gap-2'>
                ...
                <p className='text-[14px] text-gray-500'>Select your service here.</p>
            </div>
        </div>
    );
}
